...
public class GuidePanel {
    ...
    public GuidePanel() {
        try {
            screen1 = ImageIO.read(GuidePanel.class.getResource("assets/screen1.jpg"));
            screen2 = ImageIO.read(GuidePanel.class.getResource("assets/screen2.jpg"));
            screen3 = ImageIO.read(GuidePanel.class.getResource("assets/screen3.jpg"));
            screen4 = ImageIO.read(GuidePanel.class.getResource("assets/screen4.jpg"));
            screen5 = ImageIO.read(GuidePanel.class.getResource("assets/screen5.jpg"));
        } catch(Exception e) {
