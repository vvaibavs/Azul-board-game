...
public class FactoryPanel {
    ...
    public FactoryPanel(){
        try {
            factory = ImageIO.read(FactoryPanel.class.getResource("assets/factory.png"));
            black = ImageIO.read(FactoryPanel.class.getResource("assets/black.jpg"));
            blue = ImageIO.read(FactoryPanel.class.getResource("assets/blue.jpg"));
            red = ImageIO.read(FactoryPanel.class.getResource("assets/red.jpg"));
            white = ImageIO.read(FactoryPanel.class.getResource("assets/white.jpg"));
            yellow = ImageIO.read(FactoryPanel.class.getResource("assets/yellow.jpg"));
            firstT = ImageIO.read(FactoryPanel.class.getResource("assets/1tile.jpg"));
            centerimg = ImageIO.read(FactoryPanel.class.getResource("assets/center.png"));
            defaul = ImageIO.read(FactoryPanel.class.getResource("assets/default.png"));
        } catch (IOException e) {
